...
/**
 * ProductDashboard — exposed as productRemote/ProductApp via Module Federation.
 *
 * NOTE: No <Navbar> is rendered here. The shell's Layout component already
 * provides a global navbar and sidebar, so rendering one here would cause
 * a duplicate navigation bar when loaded as a micro frontend.
 */
        ...
        <div className="stats">
          ...
          <div className="search">
            ...
            <select
              ...
              style={{ marginLeft: '10px', padding: '10px', borderRadius: '10px', border: '1px solid #e5e7eb' }}
            >
            ...
            <button className="btn" onClick={handleSearch} style={{ marginLeft: '10px' }} disabled={isLoading}>
              Search
            </button>
          </div>
        </div>
                  ...
                  <tbody>
                    {products.map((p) => (
                      <tr key={p.id}>
                        ...
                        <td>
                          <span className="qty-badge" style={{ textTransform: 'uppercase' }}>
                            {p.status}
                          </span>
                        </td>
